...
def create_voice_and_subtitle(voice_name: str, text: str, voice_output_file: str, voice_rate: float = 1.0):
    logger.info("Creating audio and subtitle")
...
if __name__ == "__main__":
    ...
    create_voice_and_subtitle(
        ...
        text="Why does Waldo only wear stripes?\n.\n.\n.\n. Because he doesn't want to be spotted.",
    ...
    # text = "Why does Waldo only wear stripes? Because he doesn't want to be spotted."
    ...
    #     subtitle_file = f"{temp_dir}/tts-{voice_name}.mp3.srt"
    #     print("voice name:", voice_name)
    #     sub_maker = tts(text=text, voice_name=voice_name, voice_rate=1.0, voice_file=voice_file)
    #     print(isinstance(sub_maker, SubMaker))
